...
import type { FirebaseProduct, Price } from "@fireux/core";
...
export async function useProducts() {
  ...
  const { collectionData } = await firestoreFetchCollection("products");
  const productsCollection = collectionData as Ref<
    FirebaseProduct[] | undefined
  >;
